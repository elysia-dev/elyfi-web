  ...
  return (
    <>
      ...
      <section className="linkage">
        <Title label={t("partners.collateral_provider")} />
        <div className="linkage__collateral__providers__container">
          ...
          <div className="linkage__collateral__providers">
            ...
            <p className="linkage__collateral__providers__link spoqa">
              {t("partners.website")}: -
            </p>
          </div>
        </div>
        ...
        <div className="linkage__status__container">
          <div className="linkage__status__wrapper">
            <div className="linkage__status">
              <p className="spoqa__bold">{t("partners.collateral_provider_deposit")}</p>
          ...
          <div className="linkage__status__wrapper">
            <div className="linkage__status">
              <p className="spoqa__bold">{t("partners.borrow_limit")}</p>
          ...
          <div className="linkage__status__wrapper">
            <div className="linkage__status">
              <p className="spoqa__bold">{t("partners.borrowed")}</p>
          ...
          <div className="linkage__status__wrapper">
            <div className="linkage__status">
              <p className="spoqa__bold">{t("partners.limit_used")}</p>
