...
const Staking: React.FunctionComponent<IProps> = ({
  ...
  const [
    claimStakingRewardModalVisible,
    setClaimStakingRewardModalVisible,
  ] = useState<boolean>(false);
  const [migrationModalVisible, setMigrationModalVisible] = useState<boolean>(
    false,
  );
  const [stakingEndedVisible, setStakingEndedVisible] = useState<boolean>(
    false,
  );
  const [migrationEndedVisible, setMigrationEndedVisible] = useState<boolean>(
    false,
  );
  ...
  const [migrationRewardValue, setMigrationRewardValue] = useState(
    constants.Zero,
  );
                              ...
                              <div
                                ...
                                onClick={(e) => {
                                  ...
                                  if (
                                    ...
                                    current.diff(
                                      stakingRoundTimes[2].startedAt,
                                    ) > 0 &&
                                    current.diff(stakingRoundTimes[2].endedAt) <
                                      0
                                  ) {
                                    ReactGA.modalview(
                                ...
                                <p>
                                  {stakedToken !== Token.ELFI &&
                                  current.diff(stakingRoundTimes[2].startedAt) >
                                    0 &&
                  ...
                  <div className="staking__round__remaining-data current">
                    <div className="staking__round__remaining-data__title">
                      <div>
                        ...
                        <p>
                          {stakingRoundTimes[2].startedAt.format(
                            'YYYY.MM.DD HH:mm:ss',
                          )}
                          <br />
                          ~&nbsp;
                          {stakingRoundTimes[2].endedAt.format(
                            'YYYY.MM.DD HH:mm:ss',
                          )}{' '}
                          (KST)
                        </p>
                      ...
                      <div>
                        ...
                        <p className="spoqa__bold">
                          ...
                          current.diff(stakingRoundTimes[2].endedAt) >= 0
                            ? '-'
                            : toPercentWithoutSign(roundData[2].apr || 0)}
                          <span className="spoqa__bold staking__sign">
                            &nbsp;%
                          </span>
                        </p>
                        ...
                        <div>
                          <h2>
                            {`${
                              current.diff(stakingRoundTimes[2].startedAt) > 0
                                ? formatCommaSmall(
                                    roundData[2]?.accountPrincipal || '0',
                                  )
                                : '-'
                            }`}
